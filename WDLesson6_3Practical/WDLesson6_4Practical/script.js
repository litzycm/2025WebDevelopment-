...
for(let i = 0; i < data.length; i+=1){
    ...
    build += '
              ...
              <a href=$(criminal.pdf)> Poster> <br>
              <a target="_blank" href="https://raw.githubusercontent.com/rcastro2/WebDevelopment/main/data/fbi_media/WILFREDO_PUJOLS-SEPULVEDA.jpgfile=${criminal.pdf}"> Poster </a>
</div>
